...
const SERVICES_LIST = [
  ...
  "Control Philosophy Preparation",
  "Cause & Effect Matrices",
  "Loop Design & Verification",
  "SIS Engineering Support",
  "Telecom System Engineering"
];
            ...
            >
              ...
              <div className="w-full xl:w-[35%] relative min-h-87.5 xl:min-h-full bg-slate-100 overflow-hidden">
                <Image 
                  ...
                  alt="Instrumentation and Control Engineering Schematic"
                  fill
