...
//   title: "Project Delivery & Execution Support | Aarvi Engineering Services",
//   description: "Comprehensive engineering support from procurement and vendor review to successful commissioning and facility handover.",
//   keywords: ["project delivery","execution support","vendor engineering","commissioning support","Primavera P6","SAP PM","SmartPlant Foundation"],
//   openGraph: { title: "Project Delivery & Execution Support", type: "website" }
// };
// ──────────────────────────────────────────────────────────────────────────────
...
// ─── ASSET IMPORTS ───────────────────────────────────────────────────────────
import sharedCapabilityImg from '../../../assets/pdes.png';

// ─── DATA ────────────────────────────────────────────────────────────────────
const SERVICES_LIST = [
  "Procurement & Vendor Engineering",
  "Technical & Commercial Bid Evaluation",
  "Vendor Document Review & Technical Approval",
  "Multi-Discipline Design Coordination",
  "Site Technical Engineering Support",
  "Pre-Commissioning & Start-up Support",
  "Commissioning & Performance Testing",
  "Vendor Inspection & Expediting",
  "Shutdown & Turnaround Support",
  "Maintenance & Reliability Engineering",
  "Asset Integrity & Handover Documentation"
];
...
// ─── COMPONENT ────────────────────────────────────────────────────────────────
export default function ProjectDeliveryExecutionPage() {
  return (
    <>
      <Head>
        <title>Project Delivery & Execution Support | Aarvi Engineering Services</title>
        <meta
          name="description"
          content="Comprehensive engineering support from procurement and vendor review to successful commissioning and facility handover."
        />
        <meta name="keywords" content="project delivery, execution support, vendor engineering, commissioning support, Primavera P6, SAP PM, SmartPlant Foundation" />
        <meta property="og:title" content="Project Delivery & Execution Support | Aarvi Engineering Services" />
        <meta property="og:description" content="Seamless project execution and engineering management from FEED to Operations." />
        ...
        <section className="relative w-full min-h-[65vh] flex items-center overflow-hidden bg-aarvi-navy">
          <div className="absolute inset-0 w-full h-full">
            <video
              ...
              aria-hidden="true"
            >
              <source src="/project-delivery-hero.mp4" type="video/mp4" />
            </video>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 py-10 lg:py-14 w-full">
            ...
            >
              <div className="border-l-4 border-aarvi-green pl-6 py-2 mb-8">
                ...
                >
                  Project Delivery &<br />Execution Support
                </motion.h1>
                
                <motion.p variants={fadeUp} className="text-base lg:text-xl text-white/80 leading-relaxed font-medium max-w-2xl">
                  Comprehensive engineering management bridging the gap between detailed design and successful operations, ensuring flawless procurement, flawless installation, and on-time commissioning.
                </motion.p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            ...
            >
              ...
              <div className="w-full xl:w-[35%] relative min-h-87.5 xl:min-h-full bg-slate-100 overflow-hidden">
                <Image 
                  src={sharedCapabilityImg} 
                  alt="Project Delivery & Execution Support Schematic"
                  fill
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
            ...
            >
              ...
              <motion.div variants={fadeUp} className="shrink-0">
                <Link
                  href="/contact?service=project-delivery"
