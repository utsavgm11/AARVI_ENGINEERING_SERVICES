...
//   title: "Digitalization | Aarvi Engineering Services",
//   description: "Expert digitalization services including 2D/3D data migration, legacy drawing digitization, and SmartPlant data integration.",
//   keywords: ["digitalization","data migration","legacy digitization","SmartPlant Foundation","AVEVA Engineering","data integration"],
//   openGraph: { title: "Digitalization", type: "website" }
// };
// ──────────────────────────────────────────────────────────────────────────────
...
// ─── DATA ────────────────────────────────────────────────────────────────────
const SERVICES_LIST = [
  "Engineering 2D / 3D Data Migration",
  "Legacy Drawing Digitization",
  "SmartPlant Data Management and Integration"
];
...
export default function DigitalizationPage() {
  return (
    <>
      <Head>
        <title>Digitalization | Aarvi Engineering Services</title>
        <meta
          name="description"
          content="Expert digitalization services including 2D/3D data migration, legacy drawing digitization, and SmartPlant data integration."
        />
        <meta name="keywords" content="digitalization, data migration, legacy digitization, SmartPlant Foundation, AVEVA Engineering, data integration" />
        <meta property="og:title" content="Digitalization | Aarvi Engineering Services" />
        <meta property="og:description" content="Intelligent engineering data migration and lifecycle data management." />
        ...
        <section className="relative w-full min-h-[65vh] flex items-center overflow-hidden bg-aarvi-navy">
          <div className="absolute inset-0 w-full h-full">
            <video
              ...
              aria-hidden="true"
            >
              <source src="/digitalization-hero.mp4" type="video/mp4" />
            </video>
            ...
            >
              <div className="border-l-4 border-aarvi-green pl-6 py-2 mb-8">
                ...
                <motion.p variants={fadeUp} className="text-base lg:text-xl text-white/80 leading-relaxed font-medium max-w-2xl">
                  Transforming legacy assets and structured data into intelligent, data-centric environments to ensure perfect multi-disciplinary alignment and seamless operational handover.
                </motion.p>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="w-full xl:w-[35%] relative min-h-87.5 xl:min-h-full bg-slate-100 overflow-hidden">
                <Image 
                  ...
                  alt="Digitalization & Data Migration Schematic"
                  fill
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
            ...
            >
              ...
              <motion.div variants={fadeUp} className="shrink-0">
                <Link
                  href="/contact?service=digitalization"
